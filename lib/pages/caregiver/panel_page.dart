...
class _CaregiverPanelPageState extends State<CaregiverPanelPage> {
	static const String _commonKey = 'page.caregiverSection.panel';
    ...
    return CubitUtils.navigateOnState<ActiveUserCubit, ActiveUserState, NoActiveUser>(
			...
			child: Scaffold(
				body: Column(
					...
					children: <Widget>[
						AppHeader.greetings(text: '$_commonKey.header.pageHint', headerActionButtons: [
							HeaderActionButton.normal(Icons.add, '$_commonKey.header.addChild', () => { log("Dodaj dziecko") }),
							HeaderActionButton.normal(Icons.add, '$_commonKey.header.addCaregiver', () => { log("Dodaj opiekuna") })
						]),
	...
	List<Segment> _buildPanelSegments(CaregiverPanelLoadSuccess state) {
		return [
			Segment(
				title: '$_commonKey.content.childProfilesTitle',
				noElementsMessage: '$_commonKey.content.noChildProfilesAdded',
				elements: <Widget>[
			...
			Segment(
				title: '$_commonKey.content.caregiverProfilesTitle',
				noElementsMessage: '$_commonKey.content.noCaregiverProfilesAdded',
				elements: <Widget>[
