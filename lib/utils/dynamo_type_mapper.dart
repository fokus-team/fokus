/// Copyright aws_client project contributors
...
extension AttributeTranslator on Map<String, AttributeValue> {
  Map<String, dynamic> toJson() => map((key, value) => MapEntry(key, toDartType(value)));
}

extension DynamicTranslator on Map<String, dynamic> {
  Map<String, AttributeValue> fromJsonToAttributeValue() => map((key, value) => MapEntry(key, toAttributeValue(value)));
}
