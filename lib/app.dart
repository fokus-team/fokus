...
class FokusApp extends StatelessWidget {
	...
	Map<String, WidgetBuilder> _createRoutes() {
		...
		return {
			...
			AppPage.caregiverPanel.name: (context) => _wrapAppPage(UserRole.caregiver, CaregiverPanelPage(), ChildrenListCubit(activeUser(context))..loadCaregiverChildren()),
			...
			AppPage.childPanel.name: (context) => _wrapAppPage(UserRole.child, ChildPanelPage(), ChildPlansCubit(activeUser(context))..loadChildPlansForToday()),
