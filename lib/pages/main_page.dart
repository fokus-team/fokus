            ...
            child: Container(
							...
							child: FlatButton(
								...
								child: Row(
									...
									children: <Widget>[
										Text(
											'${AppLocales.of(context).translate("page.main.introduction")} ',
											style: TextStyle(
												fontSize: 18,
										...
										Text(
											'${AppLocales.of(context).translate("page.main.caregiver")} ',
											style: TextStyle(
												fontSize: 18,
							...
							child: FlatButton(
								...
								child: Row(
									...
									children: <Widget>[
										...
										Text(
											'${AppLocales.of(context).translate("page.main.child")} ',
											style: TextStyle(
												fontSize: 18,
												fontWeight: FontWeight.bold,
												color: ThemeConfig.lightTextColor
							...
							child: Center(
								child: Row(
									...
									children: <Widget>[
										...
										Text(
											'${AppLocales.of(context).translate("page.main.help")}',
