...
extension RewardFormLoad on BaseFormState {
	RewardFormDataLoadSuccess load({required List<Currency> currencies, required Reward reward}) =>
...
class RewardFormDataLoadSuccess extends BaseFormState {
	...
	RewardFormDataLoadSuccess copyWith({Reward? reward, DataSubmissionState? submissionState}) => RewardFormDataLoadSuccess(
