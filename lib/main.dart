  ...
  Route<dynamic> _onGenerateRoute(RouteSettings settings) {
	...
	Map<String, WidgetBuilder> _createRoutes() {
      ...
      AppPage.notificationsPage.name: (context) => _createPage(NotificationsPage(), context),
			...
			AppPage.caregiverPlanForm.name: (context) => _createPage(CaregiverPlanFormPage(), context, PlanFormCubit(getParams(context) == null ? null:(getParams(context) as Map)["type"], getActiveUser(context), getParams(context) == null ? null : (getParams(context) as Map)["date"])),
