...
class UITaskInstance extends UITaskBase {
  ...
  UITaskInstance({ObjectId id, String name, bool optional, String description, this.timer, this.duration, this.breaks, this.planInstanceId, this.points, this.taskId, this.taskUiType, this.status, this.elapsedTimePassed, this.subtasks}) : super(id, name, optional, description);
	...
	@override
	String toString() {
		return 'UITask{name: $name, optional: $optional, description: $description, duration: $duration, breaks: $breaks, timer: $timer, subtasks: $subtasks';
	}
